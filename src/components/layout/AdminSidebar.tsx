...
import { BarChart3, Bike, History, Inbox, KeyRound, LayoutDashboard, LayoutGrid, LogOut, Receipt, Settings, Tag, UtensilsCrossed, Users } from 'lucide-react'
...
const ADMIN_NAV = [
  ...
  { label: 'Dine-In', to: '/admin/dinein', icon: LayoutGrid },
