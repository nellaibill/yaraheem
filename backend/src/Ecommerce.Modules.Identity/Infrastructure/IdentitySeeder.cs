...
public static class IdentitySeeder
{
    ...
    {
        var roles = new[] { Role.WellKnown.Admin, Role.WellKnown.Customer, Role.WellKnown.DeliveryPartner };
        ...
        {
            logger.LogWarning(
                "AdminSeed:Password is not configured — skipping admin account seeding. " +
                "Set it via user-secrets (dev) or the AdminSeed__Password environment variable to seed an admin account.");
        }
        else
        {
